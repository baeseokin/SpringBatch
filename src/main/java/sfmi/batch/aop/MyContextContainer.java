...
public class MyContextContainer {
    ...
    private <T> T invokeAnnonations(T instance) throws IllegalAccessException {
        ...
        for( Field field : fields ){
        	NexusDB annotation = field.getAnnotation(NexusDB.class);
            if( annotation != null && field.getType() == String.class ){
                System.out.println("invokeAnnonations -----  field Name : "+field.getName());
            	System.out.println("invokeAnnonations -----  field Value : "+field.get(instance));
            }
        }
        return instance;
    }
