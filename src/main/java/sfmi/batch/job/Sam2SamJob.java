...
@Slf4j
public class Sam2SamJob{
	
	public static final String JOB_NAME ="Sam2SamJob";
	...
	@Bean(name = JOB_NAME)
	public Job sam2SamItemReaderJob() {
	...
	@JobScope
	public Step sam2SamStep() {
		return stepBuilderFactory.get(JOB_NAME + "_step")
				.<Player, Player> chunk(chunkSize)
				.reader(sam2SamItemReader())
				.writer(sam2SamItemWriter())
				.build();
	}
	@Bean(name = JOB_NAME +"_reader")
	@StepScope
	public FlatFileItemReader<Player> sam2SamItemReader() {
	...
	@StepScope
	public FlatFileItemWriter<Player> sam2SamItemWriter(){
