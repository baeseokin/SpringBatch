...
public class Sam2DbJob 
/* extends DefaultBatchConfigurer */
{

	public static final String JOB_NAME = "Sam2DbJob";
	...
	public Step sam2DbStep() throws Exception {
		return stepBuilderFactory.get(JOB_NAME + "_step").<Pay, Pay>chunk(chunkSize).reader(sam2DbItemReader())
