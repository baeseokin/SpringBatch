...
class JdbcCursorItemReaderJobConfigurationTest {
	@Autowired
	private JobLauncherTestUtils jobLauncherTestUtils;
	
	@Test
	void testJdbcCursorItemReaderJob() throws Exception {
		log.info(">>> start testJdbcCursorItemReaderJob");
		//LocalDate createDate = LocalDate.of(2020,10,21);
		String createDate = "20201020";
		
		JobParameters jobParameters = new JobParametersBuilder()
				.addString("createDate", createDate)
				.addString("version", "15")				
				.toJobParameters();
