...
@SpringBatchTest
@SpringBootTest(classes= {MyBatisCursorItemReaderJobConfiguration.class, TestBatchConfig.class})
@Slf4j
@ActiveProfiles("mysql")
class MyBatisCursorItemReaderJobConfigurationTest {
	@Autowired
	private JobLauncherTestUtils jobLauncherTestUtils;


	@Test
	void testMyBatisCursorItemReaderJob() throws Exception {
		log.info(">>> start testMyBatisCursorItemReaderJob");
